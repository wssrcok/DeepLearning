...
def initialize_weights_random_normal(filter_dims, layer_dims, truncate = 0, seed = 2):
    '''
    Arguments:
...
def update_weights(parameters, grads, learning_rate, truncate = 0):
    ...
    L = len(parameters) // 2
    for l in range(L):
        # TODO: bug: if I change the -= to +=, it is able to train
...
# TODO: different function takes different caches 
